...
public class myadapter extends FirebaseRecyclerAdapter<fileinfomodel,myadapter.myviewholder>
{
    ...
    public myadapter(@NonNull FirebaseRecyclerOptions<fileinfomodel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull final myviewholder holder, int position, @NonNull final fileinfomodel model) {
